...
$wpvs_video_slug_settings = get_option('wpvs-video-slug-settings', array());
$wpvs_genre_slug_settings = get_option('wpvs-genre-slug-settings', array());
$wpvs_actor_slug_settings = get_option('wpvs-actor-slug-settings', array());
$wpvs_director_slug_settings = get_option('wpvs-director-slug-settings', array());
